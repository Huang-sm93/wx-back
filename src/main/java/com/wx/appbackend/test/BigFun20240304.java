...
public class BigFun20240304 {
    ...
    public static void main(String[] args) throws WriteException, IOException {
        String name = "/Users/sm.haung/Desktop/wx-back-master/024红3.xls";
        List<List<Integer>> lastList = ReadExcelUtility.getBF(32, name);
        ...
        if (redList.size() > 0){
            try {
                book = Workbook.createWorkbook( new File("统计024红3-32.xls" ));
